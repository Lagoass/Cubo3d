...
setup(
    ...
    version="0.1.0",
    author="Lagoass",
    author_email="gustavog6@al.insper.edu.br",
    description="A simple hello world module",
    long_description=long_description,
    long_description_content_type="text/markdown",
    url="https://github.com/Lagoass/Cubo3d",  # URL do repositório do seu projeto (se houver)
    ...
    entry_points={
        'console_scripts': [
            f'cubo3d-cli={MODULE_SLUG}.main:app',
        ],
    },
